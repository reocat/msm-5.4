...
/*
 * Allocates a xfrm_sec_ns and populates it using the supplied security
...
/*
 * LSM hook implementation that allocates a xfrm_sec_ns, populates it using
...
/*
 * LSM hook implementation that allocates a xfrm_sec_ns and populates based
 * on a secid.
 */
