...
/* ambevk machine audio map (connections to rt5670 pins) */
static const struct snd_soc_dapm_route ambevk_audio_map[] = {
	/* Line In is connected to LLIN1, RLIN1 */
	{"micbias1", NULL, "Mic external"},
	{"micbias2", NULL, "Mic internal"},
	{"IN1P", NULL, "micbias1"},
	{"IN1N", NULL, "micbias1"},
	{"IN2P", NULL, "micbias2"},
	{"IN2N", NULL, "micbias2"},
...
static int ambevk_rt5670_init(struct snd_soc_pcm_runtime *rtd)
{
	return 0;
}
...
static struct snd_soc_dai_link ambevk_dai_link = {
	.name = "rt5670",
	.stream_name = "rt5670 PCM",
	.codec_dai_name = "rt5670-aif1",
	.init = ambevk_rt5670_init,
...
static const struct of_device_id ambevk_dt_ids[] = {
	{ .compatible = "ambarella,s2lmkiwi-rt5670", },
	{ /* sentinel */ }
};
...
MODULE_DESCRIPTION("Amabrella Board with rt5670 Codec for ALSA");
MODULE_LICENSE("GPL");
