 ...
 * sound/soc/s3lotus.c
 *
 * Author: Wes Tung <yhtung@ambarella.com>
 * History:
 *    2015/05/6 - [Wes Tung] Create file
 *
...
/*
* The range of MCLK in ak4951 is 11MHz ot 27MHz
*
*
*/
...
/* ambevk machine audio map (connections to ak4951 pins) */
...
static int ambevk_ak4951_init(struct snd_soc_pcm_runtime *rtd)
{
	return 0;
}
...
static struct snd_soc_dai_link ambevk_dai_link = {
	.name = "ak4951",
	.stream_name = "ak4951 PCM",
	.codec_dai_name = "ak4951-hifi",
	.init = ambevk_ak4951_init,
...
static const struct of_device_id ambevk_dt_ids[] = {
	{ .compatible = "ambarella,s3lotus-ak4951", },
	{ /* sentinel */ }
};
...
MODULE_AUTHOR("Wes Tung<yhtung@ambarella.com>");
MODULE_DESCRIPTION("Amabrella Board with AK4951 Codec for ALSA");
MODULE_LICENSE("GPL");
MODULE_ALIAS("snd-soc-s3lotus");
