...
#define AK7755_I2C_IF					//Used to select ctl interface, enable for I2C
//#define AK7755_RAM_EXT				//Used to select the F/W loading method, enable for /lib/firmware
...
#define AK7755_MAX_REGNUM		(AK7755_MAX_REGISTERS - AK7755_C0_CLOCK_SETTING1)
...
struct reg_default ak7755_reg_defaults[] ={
	{0xc0, 0x2a},
	{0xc1, 0x00},
	{0xc2, 0x10},
	{0xc3, 0x05},
