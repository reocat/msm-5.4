...
static u8 ambarella_clut_table0[AMBARELLA_CLUT_TABLE_SIZE] =
{
	0, 128, 128,
	1, 128, 128,
	2, 128, 128,
...
static u8 ambarella_blend_table0[AMBARELLA_BLEND_TABLE_SIZE] = {
...
static struct ambarella_platform_fb ambarella_platform_fb0 = {
	...
	.clut_table		= ambarella_clut_table0,
	.blend_table		= ambarella_blend_table0,
...
static u8 ambarella_clut_table1[AMBARELLA_CLUT_TABLE_SIZE] = {
	0, 128, 128,
	1, 128, 128,
	2, 128, 128,
	3, 128, 128,
...
static u8 ambarella_blend_table1[AMBARELLA_BLEND_TABLE_SIZE] = {
	0,  12, 12, 12, 12, 12, 12, 12,
	12,  12, 12, 12, 12, 12, 12, 12,
	12,  12, 12, 12, 12, 12, 12, 12,
	12,  12, 12, 12, 12, 12, 12, 12,
...
static struct ambarella_platform_fb ambarella_platform_fb1 = {
	...
	.dsp_status		= AMBA_DSP_UNKNOWN_MODE,
	.fb_status		= AMBAFB_UNKNOWN_MODE,
	.clut_table		= ambarella_clut_table1,
	.blend_table		= ambarella_blend_table1,
	.color_format		= AMBAFB_COLOR_CLUT_8BPP,
	.prealloc_line_length	= 0,
