...
#define ATAG_AMBARELLA_TOSS		0x44001120
...
extern u32 get_ambarella_toss_phys(void);
extern u32 get_ambarella_toss_virt(void);
extern u32 get_ambarella_toss_size(void);
