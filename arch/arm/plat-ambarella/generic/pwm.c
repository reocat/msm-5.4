...
static int pwm_backlight_init(struct device *dev)
{
	...
	case 0:
		...
		data->dft_brightness	=
			ambarella_board_generic.pwm0_config.max_duty / 10;
		data->pwm_period_ns	=
	...
	case 1:
		...
		data->dft_brightness	=
			ambarella_board_generic.pwm1_config.max_duty / 10;
		data->pwm_period_ns	=
	...
	case 2:
		...
		data->dft_brightness	=
			ambarella_board_generic.pwm2_config.max_duty / 10;
		data->pwm_period_ns	=
	...
	case 3:
		...
		data->dft_brightness	=
			ambarella_board_generic.pwm3_config.max_duty / 10;
		data->pwm_period_ns	=
	...
	case 4:
		...
		data->dft_brightness	=
			ambarella_board_generic.pwm4_config.max_duty / 10;
		data->pwm_period_ns	=
