...
#define APB_DEBUG_PHYS_BASE		(0xEC000000)
#define APB_DEBUG_SIZE			(0x00200000)
#endif
...
#endif
#if defined(CONFIG_PLAT_AMBARELLA_SUPPORT_MMAP_DRAMC)
#define DRAMC_PHYS_BASE			(0xea000000)
#endif
#if defined(CONFIG_PLAT_AMBARELLA_SUPPORT_MMAP_CRYPT)
#define CRYPT_BASE			(0xeb000000)
#endif
#if defined(CONFIG_PLAT_AMBARELLA_SUPPORT_MMAP_AHB64)
#define AHB64_BASE			(0xec000000)
#endif
