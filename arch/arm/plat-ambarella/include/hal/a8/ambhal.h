/**
 * @mainpage Ambarella A8 Hardware Abstraction Layer
 *
 ...
 * high level software and the low level hardware registers of the A8 chip.
 *
 * @par Objectives:
 * - Ease of Use
 * - Stability
 ...
 *
 * API calls to query the frequency of the face detection clock.
 * The face detection clock frequency cannot be set directly. It is changed by AMBHAL when the operating mode is changed. See also @ref mode_group.
 *
 ...
 *
 * @par Introduction
 * Some of the plls (@ref vout_group & @ref audio_group) in the design allow the reference clock source to be changed.
...
/**
 * @file ambhal.h
 * @brief Ambarella A8 Hardware Abstraction Layer API.
 *
 */
 ...
 * @param[in] amb_apb_peripherals_base_address Virtual address of peripherals (corresponding to physical address 0xe8000000)
 * @param[in] amb_ahb_peripherals_base_address Virtual address of peripherals (corresponding to physical address 0xe0000000)
 * @param[in] amb_dramc_base_address Virtual address of dram controller (corresponding to physical address 0xdffe0000)
 * @param[in] amb_dbg_peripherals_base_address Virtual address of peripherals (corresponding to physical address 0xec000000)
 *
...
/**
 * Get the fdet clock frequency
 *
 * @param[in] amb_hal_base_address Virtual address where ambhal is loaded by OS.
 *
 * @retval ::amb_clock_frequency_t The fdet clock frequency.
 *
 * @ingroup fdet_group
 */
