...
#if 	(IDC_INSTANCES >= 3)
#define IDC3_ENR_REG			IDC3_REG(IDC_ENR_OFFSET)
#define IDC3_CTRL_REG			IDC3_REG(IDC_CTRL_OFFSET)
#define IDC3_DATA_REG			IDC3_REG(IDC_DATA_OFFSET)
#define IDC3_STS_REG			IDC3_REG(IDC_STS_OFFSET)
#define IDC3_PSLL_REG			IDC3_REG(IDC_PSLL_OFFSET)
#define IDC3_PSLH_REG			IDC3_REG(IDC_PSLH_OFFSET)
#define IDC3_FMCTRL_REG			IDC3_REG(IDC_FMCTRL_OFFSET)
#define IDC3_FMDATA_REG			IDC3_REG(IDC_FMDATA_OFFSET)
#endif
