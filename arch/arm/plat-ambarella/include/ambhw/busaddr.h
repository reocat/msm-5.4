...
#define ORC_MDENC_BASE			(DBGBUS_BASE + ORC_MDENC_OFFSET)
#define ORC_MDDEC_BASE			(DBGBUS_BASE + ORC_MDDEC_OFFSET)
#define ORC_ME_BASE			(DBGBUS_BASE + ORC_ME_OFFSET)
#define ORC_VIN_BASE			(DBGBUS_BASE + ORC_VIN_OFFSET)
#define ORC_CODEENC_BASE		(DBGBUS_BASE + ORC_CODEENC_OFFSET)
#define ORC_CODEDEC_BASE		(DBGBUS_BASE + ORC_CODEDEC_OFFSET)
