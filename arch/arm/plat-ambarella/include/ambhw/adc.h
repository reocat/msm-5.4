...
#if (CHIP_REV == A5S)
#define ADC_CHAN0_INTR_REG		ADC_REG(0x50)
#define ADC_CHAN1_INTR_REG		ADC_REG(0x44)
#define ADC_CHAN2_INTR_REG		ADC_REG(0x48)
#define ADC_CHAN3_INTR_REG		ADC_REG(0x4c)
#else
