...
#if (SPI_INSTANCES >= 3)
#define SPI3_CTRLR0_REG			SPI3_REG(0x00)
#define SPI3_CTRLR1_REG			SPI3_REG(0x04)
#define SPI3_SSIENR_REG			SPI3_REG(0x08)
#define SPI3_MWCR_REG			SPI3_REG(0x0c)
#define SPI3_SER_REG			SPI3_REG(0x10)
#define SPI3_BAUDR_REG			SPI3_REG(0x14)
#define SPI3_TXFTLR_REG			SPI3_REG(0x18)
#define SPI3_RXFTLR_REG			SPI3_REG(0x1c)
#define SPI3_TXFLR_REG			SPI3_REG(0x20)
#define SPI3_RXFLR_REG			SPI3_REG(0x24)
#define SPI3_SR_REG			SPI3_REG(0x28)
#define SPI3_IMR_REG			SPI3_REG(0x2c)
#define SPI3_ISR_REG			SPI3_REG(0x30)
#define SPI3_RISR_REG			SPI3_REG(0x34)
#define SPI3_TXOICR_REG			SPI3_REG(0x38)
#define SPI3_RXOICR_REG			SPI3_REG(0x3c)
#define SPI3_RXUICR_REG			SPI3_REG(0x40)
#define SPI3_MSTICR_REG			SPI3_REG(0x44)
#define SPI3_ICR_REG			SPI3_REG(0x48)
#define SPI3_IDR_REG			SPI3_REG(0x58)
#define SPI3_VERSION_ID_REG		SPI3_REG(0x5c)
#define SPI3_DR_REG			SPI3_REG(0x60)
