 ...
 *
 * History:
 *	2011/12/30 - [Allen Wang] created file
 *
 * Copyright (C) 2006-2012, Ambarella, Inc.
 */

#ifndef __AMBHW__RCT_S2_H__
#define __AMBHW__RCT_S2_H__
...
#define PLL_CORTEX_CTRL_REG		RCT_REG(0x2B0)
#define PLL_CORTEX_FRAC_REG		RCT_REG(0x2B4)
#define PLL_CORTEX_CTRL2_REG		RCT_REG(0x2B8)
#define PLL_CORTEX_CTRL3_REG		RCT_REG(0x2BC)
