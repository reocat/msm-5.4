...
#define RCT_MAX_DLL_CTRL		2
#define RCT_SUPPORT_ADC16_CTRL		1
#define RCT_SUPPORT_PLL_HDMI		1
#define RCT_SUPPORT_CLOCK_SEL		1
#define RCT_SUPPORT_UNL_WDT_RST_ANAPWR	0
/****************************************************/
...
#define CORE_ARM_CLK_SRC_REG		RCT_REG(0x2dc)
#define CORE_PLL_IDSP_PLL		0x0
#define REF_CLK_REF_CLK			0x1
#define CORE_PLL_CORE_pll		0x3
...
/* ANA_PWR_REG */
#define ANA_PWR_DLL_POWER_DOWN		0x300
#define ANA_PWR_POWER_DOWN		0x020
#define ANA_PWR_NEVER_SUSPEND_USBP	0x004
#define ANA_PWR_USB_SUSPEND		0x002
