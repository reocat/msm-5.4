...
#ifndef __AMBHW__RCT_A3_H__
#define __AMBHW__RCT_A3_H__
 ...
 * SYS_CONFIG_REG
 */
#define SYS_CONFIG_RMII_SEL		0x00008000 /* Always use 0. */
#define SYS_CONFIG_SMEM_UP_2M_MODE	0x00004000 /* Always use 0. */
#define SYS_CONFIG_SMEM_2M_MODE		0x00002000 /* Always use 0. */
#define SYS_CONFIG_EMA_SEL		0x00001000 /* Always use 0. */
...
#define SYS_CONFIG_FLASH_BOOT		0x00000400
	 ...
	 */
#define SYS_CONFIG_FAST_BOOT		0x00000200 /* Always use 0. */
...
#define SYS_CONFIG_NAND_FLASH_PAGE	0x00000020 /* 0: 512Byte, 1: 2K Byte */
						   /* Idsp  / Core  / DDR   */
#define SYS_CONFIG_CLOCK_CONFIG_7	0x0000000e /* 256.5 / 256.5 / 337.5 */
#define SYS_CONFIG_CLOCK_CONFIG_6	0x0000000c /* 256.5 / 243   / 337.5 */
#define SYS_CONFIG_CLOCK_CONFIG_5	0x0000000a /* 256.5 / 216   / 337.5 */
#define SYS_CONFIG_CLOCK_CONFIG_4	0x00000008 /* 256.5 / 216   / 216   */
#define SYS_CONFIG_CLOCK_CONFIG_3	0x00000006 /* 202.5 / 202.5 / 216   */
#define SYS_CONFIG_CLOCK_CONFIG_2	0x00000004 /* 148.5 / 148.5 / 216   */
#define SYS_CONFIG_CLOCK_CONFIG_1	0x00000002 /* 148.5 / 148.5 / 148.5 */
#define SYS_CONFIG_CLOCK_CONFIG_0	0x00000000 /* 216   / 216   / 216   */
 ...
 * Core values
 */
#define PLL_CORE_135MHZ_VAL	0x1402dc0a
#define PLL_CORE_141MHZ_VAL	0x1502dc0a
#define PLL_CORE_148MHZ_VAL	0x1602dc0a
#define PLL_CORE_155MHZ_VAL	0x1702dc0a
#define PLL_CORE_162MHZ_VAL	0x1802dc0a
#define PLL_CORE_182MHZ_VAL	0x1b02dc0a
#define PLL_CORE_189MHZ_VAL	0x0e029c0a
#define PLL_CORE_202MHZ_VAL	0x0f029c0a
#define PLL_CORE_216MHZ_VAL	0x10029c0a
#define PLL_CORE_230MHZ_VAL	0x11029c0a
#define PLL_CORE_243MHZ_VAL	0x12029c0a
#define PLL_CORE_256MHZ_VAL	0x13029c0a
#define PLL_CORE_270MHZ_VAL	0x14029c0a
#define PLL_CORE_283MHZ_VAL	0x15029c0a

#if	defined(PWC_CORE_135MHZ)
#define	EXPECT_PLL_CORE_VAL	PLL_CORE_135MHZ_VAL
#elif	defined(PWC_CORE_141MHZ)
#define EXPECT_PLL_CORE_VAL	PLL_CORE_141MHZ_VAL
#elif	defined(PWC_CORE_148MHZ)
#define EXPECT_PLL_CORE_VAL	PLL_CORE_148MHZ_VAL
#elif	defined(PWC_CORE_155MHZ)
#define EXPECT_PLL_CORE_VAL	PLL_CORE_155MHZ_VAL
...
#elif	defined(PWC_CORE_230MHZ)
#define	EXPECT_PLL_CORE_VAL	PLL_CORE_230MHZ_VAL
