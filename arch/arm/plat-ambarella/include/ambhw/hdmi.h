...
#define HDMI_PACKET_VS0_REG		HDMI_REG(0x258)
#define HDMI_PACKET_VS1_REG		HDMI_REG(0x25c)
#define HDMI_PACKET_VS2_REG		HDMI_REG(0x260)
#define HDMI_PACKET_VS3_REG		HDMI_REG(0x264)
#define HDMI_PACKET_VS4_REG		HDMI_REG(0x268)
#define HDMI_PACKET_VS5_REG		HDMI_REG(0x26c)
#define HDMI_PACKET_VS6_REG		HDMI_REG(0x270)
#define HDMI_PACKET_VS7_REG		HDMI_REG(0x274)
#define HDMI_PACKET_VS8_REG		HDMI_REG(0x278)
/* Registers for I2S */
#define HDMI_I2S_MODE_REG		HDMI_REG(0x2c4)
#define HDMI_I2S_RX_CTRL_REG		HDMI_REG(0x2c8)
#define HDMI_I2S_WLEN_REG		HDMI_REG(0x2cc)
#define HDMI_I2S_WPOS_REG		HDMI_REG(0x2d0)
#define HDMI_I2S_SLOT_REG		HDMI_REG(0x2d4)
#define HDMI_I2S_RX_FIFO_GTH_REG	HDMI_REG(0x2d8)
#define HDMI_I2S_RX_CLOCK_REG		HDMI_REG(0x2dc)
#define HDMI_I2S_INIT_REG		HDMI_REG(0x2e0)
#define HDMI_I2S_RX_DATA0_REG		HDMI_REG(0x2e4)
#define HDMI_I2S_RX_DATA1_REG		HDMI_REG(0x2e8)
#define HDMI_I2S_RX_DATA2_REG		HDMI_REG(0x2ec)
#define HDMI_I2S_RX_DATA3_REG		HDMI_REG(0x2f0)
#define HDMI_I2S_FIFO_CNTR_REG		HDMI_REG(0x2f4)
#define HDMI_I2S_GATE_OFF_REG		HDMI_REG(0x2f8)
#define HDMI_PACKET_MISC_REG		HDMI_REG(0x2fc)

/* Registers for Video Part */
#define HDMI_VUNIT_VBLANK_VFRONT_REG		HDMI_REG(0x360)
#define HDMI_VUNIT_VBLANK_PULSE_WIDTH_REG	HDMI_REG(0x364)
#define HDMI_VUNIT_VBLANK_VBACK_REG		HDMI_REG(0x368)
#define HDMI_VUNIT_HBLANK_HFRONT_REG		HDMI_REG(0x36c)
#define HDMI_VUNIT_HBLANK_PULSE_WIDTH_REG	HDMI_REG(0x370)
#define HDMI_VUNIT_HBLANK_HBACK_REG		HDMI_REG(0x374)
#define HDMI_VUNIT_VACTIVE_REG			HDMI_REG(0x378)
#define HDMI_VUNIT_HACTIVE_REG			HDMI_REG(0x37c)
#define HDMI_VUNIT_CTRL_REG			HDMI_REG(0x380)
#define HDMI_VUNIT_VSYNC_DETECT_REG		HDMI_REG(0x384)

/* Registers for HDMISE Test Mode Part */
#define HDMI_HDMISE_TM_REG		HDMI_REG(0x388)

/* Registers for TMDS Asynchronous FIFO Part */
#define HDMI_P2P_AFIFO_LEVEL_REG	HDMI_REG(0x38c)
#define HDMI_P2P_AFIFO_CTRL_REG		HDMI_REG(0x390)

/* Registers for HDMI Debug mode used */
#define HDMI_HDMISE_DBG_REG		HDMI_REG(0x394)
#else	/* (VOUT_HDMI_REGS_OFFSET_GROUP == 2) */
#define HDMI_PACKET_GAMUT0_REG		HDMI_REG(0x234)
#define HDMI_PACKET_GAMUT1_REG		HDMI_REG(0x238)
#define HDMI_PACKET_GAMUT2_REG		HDMI_REG(0x23c)
...
#define HDMI_PHY_CTRL_REG		HDMI_PHY_REG(0x700)
#define HDMI_PHY_PLL_REG		HDMI_PHY_REG(0x704)
#define HDMI_PHY_FRAC_REG		HDMI_PHY_REG(0x708)

/* HDMI_PHY_CTRL_REG */
#define HDMI_PHY_CTRL_RESET_HDMI_PHY		0
#define HDMI_PHY_CTRL_NON_RESET_HDMI_PHY	1

#define HDMI_PHY_CTRL_0_MA_SINK_CURRENT		(0)
#define HDMI_PHY_CTRL_0P6_MA_SINK_CURRENT	(1)
#define HDMI_PHY_CTRL_1P2_MA_SINK_CURRENT	(2)
#define HDMI_PHY_CTRL_1P8_MA_SINK_CURRENT	(3)

#define HDMI_PHY_CTRL_0_PRE_EMPHASIS		(0)
#define HDMI_PHY_CTRL_10_PRE_EMPHASIS		(1)
#define HDMI_PHY_CTRL_20_PRE_EMPHASIS		(2)
#define HDMI_PHY_CTRL_30_PRE_EMPHASIS		(3)
...
#define HDCP_IROM_DATA_LO_REG		HDCP_REG(0x3c0)
#define HDCP_IROM_DATA_HI_REG		HDCP_REG(0x3c4)
#define HDCP_IROM_ADDR_REG		HDCP_REG(0x3c8)
#define HDCP_IROM_STATUS_REG		HDCP_REG(0x3d0)
#define HDCP_EROM_DATA_LO_REG		HDCP_REG(0x3e0)
#define HDCP_EROM_DATA_HI_REG		HDCP_REG(0x3e4)
#define HDCP_EROM_ADDR_REG		HDCP_REG(0x3e8)
#define HDCP_EROM_STATUS_REG		HDCP_REG(0x3ec)
#define HDCP_EROM_CONFIG_REG		HDCP_REG(0x3f0)
#define HDCP_I2C_PARAMS_REG		HDCP_REG(0x3f4)
#define HDCP_KRAM_DATA_LO_REG		HDCP_REG(0x400)
#define HDCP_KRAM_DATA_HI_REG		HDCP_REG(0x404)
#define HDCP_KRAM_ADDR_REG		HDCP_REG(0x408)
#define HDCP_KRAM_STATUS_REG		HDCP_REG(0x40c)
...
#define HDCP_HDCPCE_CTL_REG		HDCP_REG(0x400)
#define HDCP_AUTH_STAT_CTL_REG		HDCP_REG(0x404)
#define HDCP_HDCPCE_TX_MODE_REG		HDCP_REG(0x408)
#define HDCP_BCONF_REG			HDCP_REG(0x40c)
#define HDCP_HDCPCE_STATUS_REG		HDCP_REG(0x410)
#define HDCP_TRNG_CTL_REG		HDCP_REG(0x414)
#define HDCP_TRNG1_OUT_REG		HDCP_REG(0x418)
#define HDCP_TRNG2_OUT_REG		HDCP_REG(0x41c)
#define HDCP_CASR1_IN_LO_REG		HDCP_REG(0x420)
#define HDCP_CASR1_IN_HI_REG		HDCP_REG(0x424)
#define HDCP_LFSR1_IN_LO_REG		HDCP_REG(0x428)
#define HDCP_LFSR1_IN_HI_REG		HDCP_REG(0x42c)
#define HDCP_CASR2_IN_LO_REG		HDCP_REG(0x430)
#define HDCP_CASR2_IN_HI_REG		HDCP_REG(0x434)
#define HDCP_LFSR2_IN_LO_REG		HDCP_REG(0x438)
#define HDCP_LFSR2_IN_HI_REG		HDCP_REG(0x43c)
#define HDCP_AN_LO_REG			HDCP_REG(0x440)
#define HDCP_AN_HI_REG			HDCP_REG(0x444)
#define HDCP_ANREF_LO_REG		HDCP_REG(0x448)
#define HDCP_ANREF_HI_REG		HDCP_REG(0x44c)
#define HDCP_BKSV_LO_REG		HDCP_REG(0x450)
#define HDCP_BKSV_HI_REG		HDCP_REG(0x454)
#define HDCP_AKSV_LO_REG		HDCP_REG(0x460)
#define HDCP_AKSV_HI_REG		HDCP_REG(0x464)
#define HDCP_RI_REG			HDCP_REG(0x468)
#define HDCP_PJ_REG			HDCP_REG(0x46c)
#define HDCP_SHA_DWORD_IN_REG		HDCP_REG(0x480)
#define HDCP_SHA_DWORD_NUM_REG		HDCP_REG(0x484)
#define HDCP_SHA_DWORD_OUT0_REG 	HDCP_REG(0x488)
#define HDCP_SHA_DWORD_OUT1_REG 	HDCP_REG(0x48c)
#define HDCP_SHA_DWORD_OUT2_REG 	HDCP_REG(0x490)
#define HDCP_SHA_DWORD_OUT3_REG 	HDCP_REG(0x494)
#define HDCP_SHA_DWORD_OUT4_REG 	HDCP_REG(0x498)
#define HDCP_SHA_STATUS_REG		HDCP_REG(0x49c)
#define HDCP_IROM_DATA_LO_REG		HDCP_REG(0x4c0)
#define HDCP_IROM_DATA_HI_REG		HDCP_REG(0x4c4)
#define HDCP_IROM_ADDR_REG		HDCP_REG(0x4c8)
#define HDCP_IROM_STATUS_REG		HDCP_REG(0x4cc)
#define HDCP_EROM_DATA_LO_REG		HDCP_REG(0x4e0)
#define HDCP_EROM_DATA_HI_REG		HDCP_REG(0x4e4)
#define HDCP_EROM_ADDR_REG		HDCP_REG(0x4e8)
#define HDCP_EROM_STATUS_REG		HDCP_REG(0x4ec)
#define HDCP_EROM_CONFIG_REG		HDCP_REG(0x4f0)
#define HDCP_I2C_PARAMS_REG		HDCP_REG(0x4f4)
#define HDCP_KRAM_DATA_LO_REG		HDCP_REG(0x500)
#define HDCP_KRAM_DATA_HI_REG		HDCP_REG(0x504)
#define HDCP_KRAM_ADDR_REG		HDCP_REG(0x508)
#define HDCP_KRAM_STATUS_REG		HDCP_REG(0x50c)
...
#define CEC_INTERRUPT_REG		CEC_REG(0x008)
#define CEC_CTRL1_REG			CEC_REG(0x600)
#define CEC_STATUS_REG			CEC_REG(0x604)
#define CEC_START_PTRN_REG		CEC_REG(0x608)
#define CEC_ZERO_PTRN_REG		CEC_REG(0x60c)
#define CEC_ONE_PTRN_REG		CEC_REG(0x610)
#define CEC_CLK_PTRN_REG		CEC_REG(0x614)
#define CEC_TX_DATA0_REG		CEC_REG(0x618)
#define CEC_TX_DATA1_REG		CEC_REG(0x61c)
#define CEC_TX_DATA2_REG		CEC_REG(0x620)
#define CEC_TX_DATA3_REG		CEC_REG(0x624)
#define CEC_RX_DATA0_REG		CEC_REG(0x628)
#define CEC_RX_DATA1_REG		CEC_REG(0x62c)
#define CEC_RX_DATA2_REG		CEC_REG(0x630)
#define CEC_CTRL2_REG			CEC_REG(0x638)
#define CEC_TOLE_PTRN_LOWER_REG		CEC_REG(0x63c)
#define CEC_LOW_PTRN_REG		CEC_REG(0x640)
#define CEC_TOLE_PTRN_UPPER_REG		CEC_REG(0x644)
#define CEC_MIS_PTRN_REG		CEC_REG(0x648)
#define CEC_TX_START_PTRN_REG		CEC_REG(0x64C)
#define CEC_TX_ZERO_PTRN_REG		CEC_REG(0x650)
#define CEC_TX_ONE_PTRN_REG		CEC_REG(0x654)
#endif
