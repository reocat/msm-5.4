...
#define I2S2_MODE_REG				I2S2_REG(0x00)
#define I2S2_RX_CTRL_REG				I2S2_REG(0x04)
#define I2S2_TX_CTRL_REG				I2S2_REG(0x08)
#define I2S2_WLEN_REG				I2S2_REG(0x0c)
#define I2S2_WPOS_REG				I2S2_REG(0x10)
#define I2S2_SLOT_REG				I2S2_REG(0x14)
#define I2S2_TX_FIFO_LTH_REG			I2S2_REG(0x18)
#define I2S2_RX_FIFO_GTH_REG			I2S2_REG(0x1c)
#define I2S2_CLOCK_REG				I2S2_REG(0x20)
#define I2S2_INIT_REG				I2S2_REG(0x24)
#define I2S2_TX_STATUS_REG			I2S2_REG(0x28)
#define I2S2_TX_LEFT_DATA_REG		I2S2_REG(0x2c)
#define I2S2_TX_RIGHT_DATA_REG		I2S2_REG(0x30)
#define I2S2_RX_STATUS_REG			I2S2_REG(0x34)
#define I2S2_RX_DATA_REG				I2S2_REG(0x38)
#define I2S2_TX_FIFO_CNTR_REG		I2S2_REG(0x3c)
#define I2S2_RX_FIFO_CNTR_REG		I2S2_REG(0x40)
#define I2S2_TX_INT_ENABLE_REG		I2S2_REG(0x44)
#define I2S2_RX_INT_ENABLE_REG		I2S2_REG(0x48)
#define I2S2_RX_ECHO_REG				I2S2_REG(0x4c)
#define I2S2_24BITMUX_MODE_REG		I2S2_REG(0x50)
#define I2S2_GATEOFF_REG				I2S2_REG(0x54)
#define I2S2_CHANNEL_SELECT_REG		I2S2_REG(0x58)
#define I2S2_RX_DATA_DMA_REG			I2S2_REG_PHYS(0x80)
#define I2S2_TX_LEFT_DATA_DMA_REG	I2S2_REG_PHYS(0xc0)
