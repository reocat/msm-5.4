 ...
 *
 * $Id: dhd_linux.c 726202 2020-06-19 02:54:59Z $
 */
...
//#define CONFIG_BCMDHD_FW_PATH  "/bm28/fw_bm28.bin"
//#define CONFIG_BCMDHD_NVRAM_PATH  "/bm28/nvram_bm28.bin"
...
int dhd_bus_clk_enable(wlan_bt_handle_t handle, bus_owner_t owner)
{
	...
	if (handle == NULL) {
         ...
         * available
         */
        ret = __dhdsdio_clk_enable(dhdp->bus, owner, FALSE);
...
int dhd_bus_clk_disable(wlan_bt_handle_t handle, bus_owner_t owner)
{
	...
	if (handle == NULL) {
         ...
         * disabled
         */
        ret = __dhdsdio_clk_disable(dhdp->bus, owner, FALSE);
        dhd_os_sdunlock(dhdp);
