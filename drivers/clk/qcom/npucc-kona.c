...
static void npu_cc_kona_fixup_konav2(struct regmap *regmap)
{
	...
	npu_cc_cal_hm0_clk_src.clkr.vdd_data.rate_max[VDD_LOW] = 406000000;
	npu_cc_cal_hm0_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL] = 730000000;
	npu_cc_cal_hm0_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL_L1] =
		850000000;
	npu_cc_cal_hm0_clk_src.clkr.vdd_data.rate_max[VDD_HIGH] = 920000000;
	npu_cc_cal_hm0_clk_src.clkr.vdd_data.rate_max[VDD_HIGH_L1] = 1000000000;
	npu_cc_cal_hm1_clk_src.freq_tbl = ftbl_npu_cc_cal_hm0_clk_src_kona_v2;
	npu_cc_cal_hm1_clk_src.clkr.vdd_data.rate_max[VDD_LOW] = 406000000;
	npu_cc_cal_hm1_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL] = 730000000;
	npu_cc_cal_hm1_clk_src.clkr.vdd_data.rate_max[VDD_NOMINAL_L1] =
		850000000;
	npu_cc_cal_hm1_clk_src.clkr.vdd_data.rate_max[VDD_HIGH] = 920000000;
	npu_cc_cal_hm1_clk_src.clkr.vdd_data.rate_max[VDD_HIGH_L1] = 1000000000;
}
