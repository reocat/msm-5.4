...
{
	u8 af = (unsigned long)file_inode(seq->file)->i_private;
...
{
	u_int8_t af = (unsigned long)file_inode(seq->file)->i_private;
    ...
    bool is_target)
{
	...
	uint8_t nfproto = (unsigned long)file_inode(seq->file)->i_private;
